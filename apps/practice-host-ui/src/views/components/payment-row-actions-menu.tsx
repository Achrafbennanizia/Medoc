...
export function PaymentRowActionsMenu({
    ...
    const menuNode =
        open && portalStyle ? (
            <div ref={menuPortalRef}>
                <div
                    className="payment-row-actions-menu__panel payment-row-actions-menu__panel--portal"
                    style={portalStyle}
                    role="menu"
    ...
    return (
        <>
            <div ref={rootRef} className="payment-row-actions-menu">
                <button
                    ref={triggerRef}
                    type="button"
                    className="icon-btn payment-row-actions-menu__trigger"
                    aria-haspopup="menu"
                    aria-expanded={open}
