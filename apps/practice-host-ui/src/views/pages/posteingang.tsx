                        ...
                        <div key={a.id} className="card" style={{ padding: 16 }}>
                            <div className="row" style={{ justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
                                <div className="col" style={{ gap: 4, minWidth: 0 }}>
                                    ...
                                    {a.leistungsname || a.gesamtkosten != null ? (
                                        <p style={{ margin: "4px 0 0", fontSize: 13, color: "var(--fg-2)" }}>
                                            {a.leistungsname ?? "Leistung"}
                                            {a.gesamtkosten != null ? ` · ${a.gesamtkosten.toFixed(2)} €` : ""}
                                        </p>
                                    ) : null}
                                </div>
                            ...
                            <div className="row" style={{ gap: 8, marginTop: 12, flexWrap: "wrap" }}>
                                ...
                                {isRezeption && (a.status === "IN_BEARBEITUNG" || a.status === "ZURUECK") ? (
                                    <>
                                        <Input
