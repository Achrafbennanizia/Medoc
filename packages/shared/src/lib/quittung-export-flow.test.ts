...
import { buildQuittungExportForZahlung, isQuittungExportReady, quittungPraxisReadiness } from "./quittung-export-flow";
...
describe("quittung-export-flow (GAP-11)", () => {
    ...
    it("isQuittungExportReady when praxis name + addr present", () => {
        ...
        expect(quittungPraxisReadiness().ready).toBe(true);
    });
