...
type MemberRolle = "ARZT" | "REZEPTION";

export function KontoEinrichtenOnboardingPage() {
    const t = useT();
    const tp = useTParams();
    ...
    const [rolle, setRolle] = useState<MemberRolle>("REZEPTION");
            ...
            <div className="onboarding-card__scroll">
                ...
                <fieldset className="onboarding-fieldset">
                    ...
                    <label className="onboarding-field">
                        ...
                        <select
                            value={rolle}
                            onChange={(e) => setRolle(e.target.value as MemberRolle)}
                        >
                            <option value="REZEPTION">{t("onboarding.account.role_rezeption")}</option>
                            <option value="ARZT">{t("onboarding.account.role_arzt")}</option>
                        </select>
                    </label>
                </fieldset>
            </div>
