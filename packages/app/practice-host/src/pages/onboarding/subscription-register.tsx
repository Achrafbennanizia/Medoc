...
/** Default until plan-tier UI is restored — see docs/coordination/planned.md */
const DEFAULT_SUBSCRIPTION_PLAN = "PRO" as const;

export function SubscriptionRegisterOnboardingPage() {
    const t = useT();
    const tp = useTParams();
    ...
    return (
        <OnboardingShell wide scrollable>
            <div className="onboarding-card__scroll">
                ...
                {/* TODO(later): Plan tier picker — BASIC / PRO / ENTERPRISE cards (see planned.md) */}
