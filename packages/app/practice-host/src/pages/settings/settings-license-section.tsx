...
import { formatDateShort, formatEurFromCents } from "@/lib/settings-format";
...
export type SettingsLicenseSectionProps = {
...
export function SettingsLicenseSection({
    ...
    const desktopLicenseSummary = activeV2
        ...
        : activeV1
          ? [
                ...
                activeV1.expiresAt
                    ? tp("settings.license.valid_until", { date: formatDateShort(activeV1.expiresAt) })
                    : null,
            ]
              .filter(Boolean)
              .join(" · ")
    ...
    const portalRawMax =
        typeof portalSummary?.max_users === "number" ? portalSummary.max_users : MAX_TOTAL_STAFF;
    const portalMaxUsers = Math.min(portalRawMax, MAX_TOTAL_STAFF);
    ...
    const erUsed = typeof portalSummary?.e_prescription_month_used === "number" ? portalSummary.e_prescription_month_used : 0;
    const erQuota = typeof portalSummary?.e_prescription_month_quota === "number" ? portalSummary.e_prescription_month_quota : 0;
    ...
    const heroSub = portalConnected
        ? tp("settings.license.hero_with_portal", {
              name:
                  typeof portalSummary.display_name === "string" ? portalSummary.display_name : "Practice",
              max: portalMaxUsers,
              storage: portalStorageGb,
          })
        : tp("settings.license.hero_fallback", { max: MAX_TOTAL_STAFF });
        ...
        <>
                ...
                <div className="settings-license-hero">
                    ...
                    <div className="settings-license-hero__grid">
                        ...
                        <div className="settings-license-metric">
                            ...
                            <strong>
                                {portalConnected
                                    ? formatDateShort(portalSummary.next_billing_iso)
                                    : t("common.dash")}
                            </strong>
                        </div>
                        {LICENSE_BILLING_CONNECTORS_ENABLED ? (
            ...
            <section className="settings-subcard">
                ...
                <div className="card-pad" style={{ display: "grid", gap: 16 }}>
                    ...
                    <div>
                        <div className="row" style={{ justifyContent: "space-between", fontSize: 13 }}>
                            <span>{t("settings.license.e_prescription_month")}</span>
