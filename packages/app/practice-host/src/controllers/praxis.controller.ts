...
export async function listAbwesenheiten(): Promise<Abwesenheit[]> {
    return practiceSystem.invoke<Abwesenheit[]>("list_abwesenheiten");
}
...
export async function createAbwesenheit(data: {
    ...
    return practiceSystem.invoke<Abwesenheit>("create_abwesenheit", { data });
}
...
export async function updateAbwesenheit(
    ...
    return practiceSystem.invoke<Abwesenheit>("update_abwesenheit", { id, data });
}

export async function deleteAbwesenheit(id: string): Promise<void> {
    return practiceSystem.invoke("delete_abwesenheit", { id });
}

export async function listDokumentVorlagen(): Promise<DokumentVorlage[]> {
    return practiceSystem.invoke<DokumentVorlage[]>("list_dokument_vorlagen");
}
...
export async function createDokumentVorlage(data: {
    ...
    return practiceSystem.invoke<DokumentVorlage>("create_dokument_vorlage", { data });
}
...
export async function updateDokumentVorlage(
    ...
    return practiceSystem.invoke<DokumentVorlage>("update_dokument_vorlage", { id, data });
}

export async function deleteDokumentVorlage(id: string): Promise<void> {
    return practiceSystem.invoke("delete_dokument_vorlage", { id });
}

export async function listBehandlungsKatalog(): Promise<BehandlungsKatalogItem[]> {
    return practiceSystem.invoke<BehandlungsKatalogItem[]>("list_behandlungs_katalog");
}
...
export async function createBehandlungsKatalogItem(data: {
    ...
    return practiceSystem.invoke<BehandlungsKatalogItem>("create_behandlungs_katalog_item", { data });
}
...
export async function createLieferantPharmaVorlage(data: {
    ...
    return practiceSystem.invoke<LieferantPharmaVorlage>("create_lieferant_pharma_vorlage", { data });
}

export async function deleteLieferantPharmaVorlage(id: string): Promise<void> {
    return practiceSystem.invoke("delete_lieferant_pharma_vorlage", { id });
}
