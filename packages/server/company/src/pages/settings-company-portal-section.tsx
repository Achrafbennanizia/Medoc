...
export function SettingsCompanyPortalSection({ embedded = false }: { embedded?: boolean } = {}) {
        ...
        <>
            <div className="card-pad" style={{ display: "flex", flexDirection: "column", gap: 12, paddingTop: 0 }}>
                ...
                <div className="row" style={{ gap: 8, alignItems: "flex-end", flexWrap: "wrap" }}>
                    ...
                    <Button type="button" variant="ghost" size="sm" onClick={() => setShowKey((version) => !version)}>
