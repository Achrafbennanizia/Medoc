...
/** Pfeil nach oben im Kreis — Upload-Zone */
export const UploadCircleIcon: FC<{ size?: number }> = ({ size = 44 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
        <circle cx="12" cy="12" r="9" fill="var(--blue-soft)" stroke="var(--blue)" strokeWidth="1.25" />
        <path d="M12 8.5v6.5M9.2 11.2L12 8.5l2.8 2.8" stroke="var(--blue)" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
/** Emergency / Notfall — paths aligned with Lucide `ambulance` (lucide-static, ISC). */
...
const UsersIcon: FC<{ size?: number }> = ({ size = 17 }) => <IconBase size={size}><circle cx="9" cy="8" r="3" /><path d="M3 19c0-3 2.7-5 6-5s6 2 6 5" /><path d="M17 11a3 3 0 110-6M18 19c0-2.2-1.3-3.8-3.3-4.6" /></IconBase>;
...
const PackageIcon: FC<{ size?: number }> = ({ size = 17 }) => <IconBase size={size}><path d="M12 3l8 4-8 4-8-4 8-4z" /><path d="M4 7v10l8 4 8-4V7" /><path d="M12 11v10" /></IconBase>;
...
const ToothIcon: FC<{ size?: number }> = ({ size = 17 }) => <IconBase size={size}><path d="M12 3c3 0 5 2 5 5 0 6-1 12-3 12-1.2 0-1.3-2-2-3-.7 1-1 3-2 3-2 0-3-6-3-12 0-3 2-5 5-5z" /></IconBase>;
const ClipboardIcon: FC<{ size?: number }> = ({ size = 17 }) => <IconBase size={size}><rect x="6" y="4" width="12" height="17" rx="2" /><path d="M9 4.5h6" /></IconBase>;
...
const HelpCircleIcon: FC<{ size?: number }> = ({ size = 17 }) => (
    <IconBase size={size}>
