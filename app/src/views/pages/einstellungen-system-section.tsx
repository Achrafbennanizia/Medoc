...
import { EinstellungenCompanyPortalSection } from "@/views/pages/einstellungen-company-portal-section";
import { EinstellungenLanHostSection } from "@/views/pages/einstellungen-lan-host";
