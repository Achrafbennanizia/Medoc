...
macro_rules! medoc_invoke_handler {
    () => {
        tauri::generate_handler![
            ...
            $crate::commands::network::verbund::verbund_sync_staff_directory,
            ...
            $crate::commands::network::verbund::verbund_cluster_reset_preview,
            $crate::commands::network::verbund::verbund_execute_cluster_reset,
