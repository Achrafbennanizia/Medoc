...
Audit date: 2026-05-02. Breakpoint reference: `--bp-md` / `BP_MD` = **900px** (`apps/practice-host-ui/src/index.css`, `apps/practice-host-ui/src/lib/breakpoints.ts`).  
...
|-------------|---------------------|---------|--------------|
| App shell sidebar | `app-layout.tsx` (sidebar + `apps/practice-host-ui/src/index.css` ~2691+) | Prior: drawer hid entire nav below 1000px; no persistent icon affordance. | **Done:** ≤899px icon rail + hamburger overlay; ≥900px optional `data-sidebar-rail="icons"`. |
