...
`.github/workflows/verify.yml` sets `MEDOC_VENDOR_PUBKEY` for the Rust verification job. Local developers must export the same variable (or your org’s production pubkey for release builds).
