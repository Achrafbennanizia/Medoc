...
- CI-Gate: `cargo fmt -- --check`, `cargo test`, `cargo clippy -- -D warnings`, `cargo audit`, `npm run lint`, typecheck, `npm test`, `npm run build`, axe-critical (siehe `.github/workflows/verify.yml`).
