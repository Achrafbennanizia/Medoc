...
- CI-Gate: `cargo fmt -- --check`, `cargo check`, `cargo test`, `cargo clippy -- -D warnings`, `cargo audit`, `npm run lint`, `npm test`, `npm run build` (siehe `.github/workflows/verify.yml`).
