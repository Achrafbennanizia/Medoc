...
| C3 | CI includes Next.js app under `src/` | legacy `.github/workflows/ci.yml` job `next-web` | **Resolved 2026-05-19** — job removed; tiered workflows now in `verify.yml`/`release.yml`; no `src/package.json` in tree |
