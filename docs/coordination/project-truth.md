...
- **CI/CD scope:** tiered workflows in `.github/workflows/{verify,autofix,fix-proposal,release}.yml`; verify is read-only and targets the repo-root `apps/crates/packages` workspaces. **No** root-level `src/` Next.js tree in repo.
...
| CI commands | `.github/workflows/verify.yml` | 2026-07-10 |
...
| CI without next-web | `.github/workflows/verify.yml` | 2026-07-10 |
