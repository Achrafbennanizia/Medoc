...
- **CI/CD scope:** `.github/workflows/verify.yml` (blocking verify), `.github/workflows/autofix.yml` (PR-only deterministic fixes), `.github/workflows/fix-proposal.yml` (draft PR proposals), `.github/workflows/release.yml` (manual-approval release gate + signed artifacts). Verify covers Rust fmt/clippy/test/audit and JS lint/typecheck/test/build + axe audit from root workspace scripts.
...
| CI/CD commands | `.github/workflows/verify.yml`, `.github/workflows/autofix.yml`, `.github/workflows/fix-proposal.yml`, `.github/workflows/release.yml` | 2026-06-11 |
