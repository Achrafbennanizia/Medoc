...
- **CI scope:** `.github/workflows/verify.yml` (blocking verify), `.github/workflows/autofix.yml` (deterministic PR autofix), `.github/workflows/fix-proposal.yml` (draft PR proposals on red main/manual), `.github/workflows/release.yml` (tag/dispatch gated signed build). **No** root-level `src/` Next.js tree in repo (2026-05-19).
...
| CI commands | `.github/workflows/verify.yml`, `.github/workflows/autofix.yml`, `.github/workflows/release.yml` | 2026-07-25 |
...
| CI without next-web | `.github/workflows/verify.yml` | 2026-07-25 |
