...
- **CI/CD scope:** tiered workflows in `.github/workflows/{verify,autofix,fix-proposal,release}.yml`; verify runs Rust fmt/clippy/test/audit + JS lint/typecheck/test/build + axe-core a11y gate. Auto-fix is PR-only deterministic formatting/linting; release is verify-gated and signed under protected environment.
...
| CI/CD commands | `.github/workflows/verify.yml`, `.github/workflows/autofix.yml`, `.github/workflows/fix-proposal.yml`, `.github/workflows/release.yml` | 2026-08-27 |
...
| Tiered CI without legacy `next-web` pathing | `.github/workflows/verify.yml` | 2026-08-27 |
