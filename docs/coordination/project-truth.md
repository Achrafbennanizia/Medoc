...
- **CI scope (2026-08-26):** tiered workflows — `.github/workflows/verify.yml` (non-mutating gate: Rust fmt/clippy/test/audit + JS lint/typecheck/test/build + a11y), `.github/workflows/autofix.yml` (PR-only deterministic fixes with bot loop guard), `.github/workflows/fix-proposal.yml` (draft PR proposals on manual or failed-main verify), `.github/workflows/release.yml` (verify reuse + protected signed build). Legacy `.github/workflows/ci.yml` removed.
...
| CI commands (tiered) | `.github/workflows/verify.yml`, `.github/workflows/autofix.yml`, `.github/workflows/fix-proposal.yml`, `.github/workflows/release.yml` | 2026-08-26 |
...
| Historical CI without next-web | `.github/workflows/ci.yml` (removed 2026-08-26) | 2026-05-19 |
